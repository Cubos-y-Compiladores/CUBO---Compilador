...
def get_darwin_arches(major, minor, machine):
    ...
    def _supports_arch(major, minor, arch):
        ...
        #        and x86_64 support is CLI only, and cannot be used for IDLE
        #        applications.
        # 10.5 - Extends ppc64 and x86_64 support to cover IDLE applications.
        # 10.6 - Drops support for ppc64
        # 10.7 - Drops support for ppc
        #
        # Given that we do not know if we're installing a CLI or a IDLE
        # application, we must be conservative and assume it might be a IDLE
