...
def p_doubleAssignment(p):
    ...
    p[0] = NonTerminalNode("DoubleAssignment",
                           [p[1], TerminalNode("Comma", "COMMA"), p[3], TerminalNode("Assign", "ASSIGN"), p[5],
                            TerminalNode("Comma", "COMMA"), p[7]])
...
def p_type(p):
    ...
    p[0] = NonTerminalNode("TypeF", [TerminalNode("Type", "TYPE"), TerminalNode("Lparent", "LPARENT"), p[3],
                                     TerminalNode("Rparent", "RPARENT")])


def p_range(p):
    '''a_content : RANGE LPARENT iterable COMMA value RPARENT'''
    p[0] = NonTerminalNode("RangeF", [TerminalNode("Range", "RANGE"), TerminalNode("Lparent", "LPARENT"), p[3],
                                      TerminalNode("Comma", "COMMA"), p[5], TerminalNode("Rparent", "RPARENT")])


def p_insert(p):
    '''insert : identifier DOT INSERT LPARENT i_content RPARENT SEMICOLON '''
    p[0] = NonTerminalNode("InsertF", [p[1], TerminalNode("Dot", "DOT"), TerminalNode("Insert", "INSERT"),
                                       TerminalNode("Lparent", "LPARENT"), p[5], TerminalNode("Rparent", "RPARENT")])


def p_del(p):
    ''' del : identifier DOT DEL LPARENT iterable RPARENT SEMICOLON '''
    p[0] = NonTerminalNode("DelF", [p[1], TerminalNode("Dot", "DOT"), TerminalNode("Del", "DEL"),
                                    TerminalNode("Lparent", "LPARENT"), p[5], TerminalNode("Rparent", "RPARENT")])


def p_len(p):
    ''' len : LEN LPARENT identifier RPARENT SEMICOLON '''
    p[0] = NonTerminalNode("LenF", [TerminalNode("Len", "LEN"), TerminalNode("Lparent", "LPARENT"), p[3],
                                    TerminalNode("Rparent", "RPARENT")])
...
def p_blink(p):
    ...
    p[0] = NonTerminalNode("BlinkF", [TerminalNode("Blink", "BLINK"), TerminalNode("Lparent", "LPARENT"), p[3],
                                      TerminalNode("Rparent", "RPARENT")])


def p_delay(p):
    '''delay : DELAY LPARENT d_content RPARENT SEMICOLON '''
    p[0] = NonTerminalNode("DelayF", [TerminalNode("Delay", "DELAY"), TerminalNode("Lparent", "LPARENT"), p[3],
                                      TerminalNode("Rparent", "RPARENT")])
...
def p_delete(p):
    ...
    p[0] = NonTerminalNode("DeleteF", [p[1], TerminalNode("Dot", "DOT"), TerminalNode("Delete", "DELETE"),
                                       TerminalNode("Lparent", "LPARENT"), p[5], TerminalNode("Comma", "COMMA"),
                                       TerminalNode("Int", p[7]), TerminalNode("Rparent", "RPARENT")])
...
def p_for(p):
    ...
    p[0] = NonTerminalNode("ForC",
                           [TerminalNode("For", "FOR"), TerminalNode("Id", p[2]), TerminalNode("In", "IN"), p[4], p[5],
                            TerminalNode("Lcorch", "LCORCH"), p[7], TerminalNode("Rcorch", "RCORCH")])
...
def p_statement(p):
    ...
    p[0] = NonTerminalNode("Statement", [TerminalNode("If", "IF"), TerminalNode("Lparent", "LPARENT"), p[3], p[4], p[5],
                                         TerminalNode("Rparent", "RPARENT"), TerminalNode("Lcorch", "LCORCH"), p[8],
                                         TerminalNode("Rcorch", "RCORCH"), p[11]])


def p_optStatment(p):
    '''opt_statement : ELSE LCORCH alt_block RCORCH SEMICOLON '''
    p[0] = NonTerminalNode("OptStatement", [TerminalNode("Else", "ELSE"), TerminalNode("Lcorch", "LCORCH"), p[3],
                                            TerminalNode("Rcorch", "RCORCH")])
...
def p_procedure(p):
    ...
    p[0] = NonTerminalNode("ProcedureP",
                           [TerminalNode("Procedure", "PROCEDURE"), p[2], TerminalNode("Lcorch", "LCORCH"), p[4],
                            TerminalNode("Rcorch", "RCORCH")])


def p_procDec(p):
    '''proc_dec : proc_name LPARENT parameter RPARENT'''
    p[0] = NonTerminalNode("ProcDec",
                           [p[1], TerminalNode("Lparent", "LPARENT"), p[3], TerminalNode("Rparent", "RPARENT")])


def p_procCall(p):
    '''proc_call : proc_name LPARENT param RPARENT'''
    p[0] = NonTerminalNode("ProcCall",
                           [p[1], TerminalNode("Lparent", "LPARENT"), p[3], TerminalNode("Rparent", "RPARENT")])
...
def p_mainProcedure(p):
    ...
    line = len(p.stack)
    p[0] = NonTerminalNode("MainProc", [TerminalNode("Main", "MAIN"), TerminalNode("Lparent", "LPARENT"),
                                        TerminalNode("Rparent", "RPARENT"), TerminalNode("Lcorch", "LCORCH"), p[5],
                                        TerminalNode("Rcorch", "RCORCH"), p[8]])
...
def p_compile(p):
    ...
    p[0] = NonTerminalNode("Compile", [TerminalNode("Compile", "COMPILE"), TerminalNode("Lparent", "LPARENT"), p[3],
                                       TerminalNode("Rparent", "RPARENT")])
...
def p_const0(p):
    ...
    p[0] = NonTerminalNode("Const0", [TerminalNode("Timer", "TIMER"), TerminalNode("Assign", "ASSIGN"),
                                      TerminalNode("Int", p[3])])
...
def p_const3(p):
    ...
    p[0] = NonTerminalNode("Const3",
                           [TerminalNode("Cubo", "CUBE"), TerminalNode("Assign", "ASSIGN"), TerminalNode("Int", p[3])])
...
def p_Fcont0(p):
    ...
    p[0] = NonTerminalNode("Fcont0", [p[1], TerminalNode("Comma", "COMMA"), TerminalNode("Int", p[3]),
                                      TerminalNode("Comma", "COMMA"), p[5], TerminalNode("Comma", "COMMA"), p[7]])
...
def p_EmptyList(p):
    ...
    p[0] = NonTerminalNode("EmptyList",
                           [TerminalNode("Parentcl", "PARENTCL"), Null(), TerminalNode("Parentcr", "PARENTCR")])
...
def p_ListconsultT0(p):
    ...
    p[0] = NonTerminalNode("ListConsultT0",
                           [TerminalNode("Parentcl", "PARENTCL"), p[2], TerminalNode("Parentcr", "PARENTCR")])


def p_LstconsultT1(p):
    '''list_consultT : PARENTCL indice TP indice PARENTCR '''
    p[0] = NonTerminalNode("ListConsultT1", [TerminalNode("Parentcl", "PARENTCL"), p[2], TerminalNode("Tp", "TP"), p[4],
                                             TerminalNode("Parentcr", "PARENTCR")])
...
def p_MatconsultT0(p):
    ...
    p[0] = NonTerminalNode("MatConsultT0",
                           [TerminalNode("Parentcl", "PARENTCL"), p[2], TerminalNode("Comma", "COMMA"), p[4],
                            TerminalNode("Parentcr", "PARENTCR")])


def p_MatconsultT1(p):
    '''mat_consultT : PARENTCL TP COMMA indice PARENTCR '''
    p[0] = NonTerminalNode("MatConsultT1", [TerminalNode("Parentcl", "PARENTCL"), TerminalNode("Tp", "TP"),
                                            TerminalNode("Comma", "COMMA"), p[4], TerminalNode("Parentcr", "PARENTCR")])


def p_MatconsultT2(p):
    '''mat_consultT : PARENTCL TP COMMA indice PARENTCR list_consultT'''
    p[0] = NonTerminalNode("MatConsultT2", [TerminalNode("Parentcl", "PARENTCL"), TerminalNode("Tp", "TP"),
                                            TerminalNode("Coma", "COMMA"), p[4], TerminalNode("Parentcr", "PARENTCR"),
                                            p[6]])


def p_MatconsultT3(p):
    '''mat_consultT : PARENTCL indice PARENTCR list_consultT'''
    p[0] = NonTerminalNode("MatConsultT3",
                           [TerminalNode("Parentcl", "PARENTCL"), p[2], TerminalNode("Parentcr", "PARENTCR"), p[4]])
...
def p_3dMatconsultT0(p):
    ...
    p[0] = NonTerminalNode("ThreeDMatConsultT0",
                           [TerminalNode("Parentcl", "PARENTCL"), p[2], TerminalNode("Comma", "COMMA"), p[4],
                            TerminalNode("Comma", "COMMA"), p[6], TerminalNode("Parentcr", "PARENTCR")])


def p_3dMatconsultT1(p):
    '''3dmat_consultT : PARENTCL indice PARENTCR mat_consultT'''
    p[0] = NonTerminalNode("ThreeDMatConsultT1",
                           [TerminalNode("Parentcl", "PARENTCL"), p[2], TerminalNode("Parentcr", "PARENTCR"), p[4]])
...
def p_error(p):
    if (p):
        print(colorama.Fore.RED + "SYNTACTIC ERROR: line:", p.lexer.lineno, "position:", p.lexpos, "Syntax error:",
              p.value, colorama.Fore.RESET)
    else:
        print(colorama.Fore.RED + "SYNTACTIC ERROR: Unknown syntax error" + colorama.Fore.RESET)
    sys.exit()


def runCompile(input):
    parser = yacc.yacc()
