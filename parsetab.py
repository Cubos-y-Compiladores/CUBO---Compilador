...
_lr_productions = [
  ...
  ('program -> const_block main_proc','program',2,'p_program','Parser.py',23),
  ('const_block -> const const const const const block','const_block',6,'p_constB','Parser.py',28),
  ('block -> procedure block','block',2,'p_block0','Parser.py',33),
  ('block -> global block','block',2,'p_block1','Parser.py',38),
  ('block -> empty','block',1,'p_blockEmp','Parser.py',43),
  ('alt_block -> alt_content alt_block','alt_block',2,'p_altBlock','Parser.py',53),
  ('alt_block -> empty','alt_block',1,'p_emptyaltBlock','Parser.py',58),
  ('alt_content -> instruction','alt_content',1,'p_altContent0','Parser.py',63),
  ('alt_content -> assignment','alt_content',1,'p_altContent1','Parser.py',68),
  ('instruction -> function','instruction',1,'p_instruction0','Parser.py',78),
  ('instruction -> consult SEMICOLON','instruction',2,'p_instruction1','Parser.py',83),
  ('instruction -> cycle','instruction',1,'p_instruction2','Parser.py',88),
  ('instruction -> statement','instruction',1,'p_instruction3','Parser.py',93),
  ('global -> GLOBAL assignment','global',2,'p_globalAssignment','Parser.py',103),
  ...
  ('main_body -> BEGIN main_block END SEMICOLON','main_body',4,'p_mainBody','Parser.py',352),
  ('main_block -> instruction main_block','main_block',2,'p_mainBlock','Parser.py',357),
  ('main_block -> empty','main_block',1,'p_EmptyMainblok','Parser.py',363),
  ('arithmetic -> term','arithmetic',1,'p_arithmetic0','Parser.py',373),
  ('arithmetic -> adding_operator term','arithmetic',2,'p_arithmetic1','Parser.py',377),
  ('arithmetic -> arithmetic adding_operator term','arithmetic',3,'p_arithmetic2','Parser.py',382),
  ('term -> factor','term',1,'p_term0','Parser.py',392),
  ('term -> term multiplying_operator factor','term',3,'p_term1','Parser.py',397),
  ('factor -> INT','factor',1,'p_factor0','Parser.py',407),
  ('factor -> ID','factor',1,'p_factor1','Parser.py',412),
  ('factor -> LPARENT arithmetic RPARENT','factor',3,'p_factor2','Parser.py',417),
  ('const -> TIMER ASSIGN INT SEMICOLON','const',4,'p_const0','Parser.py',427),
  ('const -> RANGOTIMER ASSIGN time_mes SEMICOLON','const',4,'p_const1','Parser.py',432),
  ('const -> dimension ASSIGN INT SEMICOLON','const',4,'p_const2','Parser.py',437),
  ('const -> CUBO ASSIGN INT SEMICOLON','const',4,'p_const3','Parser.py',442),
  ('a_content -> value','a_content',1,'p_Acont0','Parser.py',452),
  ('a_content -> arithmetic','a_content',1,'p_Acont1','Parser.py',457),
  ('a_content -> list','a_content',1,'p_Acont2','Parser.py',462),
  ('a_content -> mat','a_content',1,'p_Acont3','Parser.py',467),
  ('a_content -> 3dmat','a_content',1,'p_Acont4','Parser.py',472),
  ('a_content -> consult','a_content',1,'p_Acont5','Parser.py',477),
  ('b_content -> list_consult COMMA INT COMMA time_mes COMMA value','b_content',7,'p_Fcont0','Parser.py',486),
  ('b_content -> list_consult COMMA value','b_content',3,'p_Fcont1','Parser.py',491),
  ('d_content -> empty','d_content',1,'p_Fcont2','Parser.py',496),
  ('d_content -> INT COMMA time_mes','d_content',3,'p_Fcont3','Parser.py',501),
  ('tf -> T','tf',1,'p_Fcont4','Parser.py',506),
  ('tf -> F','tf',1,'p_Fcont5','Parser.py',511),
  ('i_content -> INT COMMA value','i_content',3,'p_Fcont6','Parser.py',516),
  ('i_content -> list COMMA INT i_ind','i_content',4,'p_Fcont7','Parser.py',521),
  ('list -> PARENTCL list_term PARENTCR','list',3,'p_list','Parser.py',531),
  ('list -> PARENTCL empty PARENTCR','list',3,'p_EmptyList','Parser.py',536),
  ('list_term -> list_value COMMA list_term','list_term',3,'p_listT0','Parser.py',541),
  ('list_term -> list_value','list_term',1,'p_listT1','Parser.py',546),
  ('list_value -> value','list_value',1,'p_listV','Parser.py',551),
  ('mat -> PARENTCL mat_term PARENTCR','mat',3,'p_mat','Parser.py',556),
  ('mat_term -> mat_value COMMA mat_term','mat_term',3,'p_matT0','Parser.py',561),
  ('mat_term -> mat_value','mat_term',1,'p_matT1','Parser.py',566),
  ('mat_value -> list','mat_value',1,'p_matV','Parser.py',571),
  ('3dmat -> PARENTCL 3dmat_term PARENTCR','3dmat',3,'p_3dmat','Parser.py',576),
  ('3dmat_term -> 3dmat_value COMMA 3dmat_term','3dmat_term',3,'p_3dmatT0','Parser.py',581),
  ('3dmat_term -> 3dmat_value','3dmat_term',1,'p_3dmatT1','Parser.py',586),
  ('3dmat_value -> mat','3dmat_value',1,'p_3dmatV','Parser.py',591),
  ('consult -> list_consult','consult',1,'p_consult0','Parser.py',596),
  ('consult -> mat_consult','consult',1,'p_consult1','Parser.py',601),
  ('consult -> 3dmat_consult','consult',1,'p_consult2','Parser.py',606),
  ('list_consult -> ID list_consultT','list_consult',2,'p_Listconsult','Parser.py',611),
  ('list_consultT -> PARENTCL indice PARENTCR','list_consultT',3,'p_ListconsultT0','Parser.py',616),
  ('list_consultT -> PARENTCL indice TP indice PARENTCR','list_consultT',5,'p_LstconsultT1','Parser.py',621),
  ('mat_consult -> ID mat_consultT','mat_consult',2,'p_Matconsult','Parser.py',626),
  ('mat_consultT -> PARENTCL indice COMMA indice PARENTCR','mat_consultT',5,'p_MatconsultT0','Parser.py',631),
  ('mat_consultT -> PARENTCL TP COMMA indice PARENTCR','mat_consultT',5,'p_MatconsultT1','Parser.py',636),
  ('mat_consultT -> PARENTCL TP PARENTCR list_consultT','mat_consultT',4,'p_MatconsultT2','Parser.py',641),
  ('mat_consultT -> PARENTCL indice PARENTCR list_consultT','mat_consultT',4,'p_MatconsultT3','Parser.py',646),
  ('3dmat_consult -> ID 3dmat_consultT','3dmat_consult',2,'p_3dMatconsult','Parser.py',651),
  ('3dmat_consultT -> PARENTCL indice COMMA indice COMMA indice PARENTCR','3dmat_consultT',7,'p_3dMatconsultT0','Parser.py',656),
  ('3dmat_consultT -> PARENTCL indice PARENTCR mat_consultT','3dmat_consultT',4,'p_3dMatconsultT1','Parser.py',661),
  ('indice -> INT','indice',1,'p_indice0','Parser.py',669),
  ('indice -> ID','indice',1,'p_indice1','Parser.py',674),
  ('i_ind -> COMMA INT','i_ind',2,'p_Insind0','Parser.py',679),
  ('i_ind -> empty','i_ind',1,'p_InsindEmp','Parser.py',684),
  ('dimension -> DIMFILAS','dimension',1,'p_dim0','Parser.py',692),
  ('dimension -> DIMCOLUMNAS','dimension',1,'p_dim1','Parser.py',697),
  ('time_mes -> QUOTES MIL QUOTES','time_mes',3,'p_timeM0','Parser.py',707),
  ('time_mes -> QUOTES MIN QUOTES','time_mes',3,'p_timeM1','Parser.py',712),
  ('time_mes -> QUOTES SEG QUOTES','time_mes',3,'p_timeM2','Parser.py',717),
  ('adding_operator -> PLUS','adding_operator',1,'p_addingOp0','Parser.py',727),
  ('adding_operator -> MINUS','adding_operator',1,'p_addingOp1','Parser.py',732),
  ('multiplying_operator -> TIMES','multiplying_operator',1,'p_multiplyingOp0','Parser.py',737),
  ('multiplying_operator -> EXP','multiplying_operator',1,'p_multiplyingOp1','Parser.py',741),
  ('multiplying_operator -> DIVIDE','multiplying_operator',1,'p_multiplyingOp2','Parser.py',746),
  ('multiplying_operator -> DIVENT','multiplying_operator',1,'p_multiplyingOp3','Parser.py',751),
  ('multiplying_operator -> MOD','multiplying_operator',1,'p_multiplyingOp4','Parser.py',756),
  ('value -> FALSE','value',1,'p_value0','Parser.py',766),
  ('value -> TRUE','value',1,'p_value1','Parser.py',771),
  ('bif_value -> value','bif_value',1,'p_Bifvalue0','Parser.py',776),
  ('bif_value -> arithmetic','bif_value',1,'p_Bifvalue1','Parser.py',781),
  ('relation -> ASSIGN','relation',1,'p_relation0','Parser.py',787),
  ('relation -> NE','relation',1,'p_relation1','Parser.py',792),
  ('relation -> LT','relation',1,'p_relation2','Parser.py',797),
  ('relation -> GT','relation',1,'p_relation3','Parser.py',802),
  ('relation -> LTE','relation',1,'p_relation4','Parser.py',807),
  ('relation -> GTE','relation',1,'p_relation5','Parser.py',812),
  ('relation -> COMPARE','relation',1,'p_relation6','Parser.py',817),
  ('identifier -> ID','identifier',1,'p_identifier0','Parser.py',825),
  ('identifier -> consult','identifier',1,'p_identifier1','Parser.py',829),
  ('iterable -> identifier','iterable',1,'p_iterable0','Parser.py',838),
  ('iterable -> INT','iterable',1,'p_iterable1','Parser.py',843),
  ('empty -> <empty>','empty',0,'p_empty','Parser.py',853),
]
